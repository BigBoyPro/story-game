...
function HowToPlayView() {
    ...
    return (
        <div className="how-to-play-page">
            <button className="button" onClick={goPrevRule}>Previous</button> {/* Move the left arrow button here */}
            ...
            <button className="button" onClick={goNextRule}>Next</button> {/* Move the right arrow button here */}
        </div>
    );
}
